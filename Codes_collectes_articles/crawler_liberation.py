...
def collect_url_articles():
    ...
    """
    liste_url = ['http://www.liberation.fr/recherche/?sort=-publication_date_time&q=cyclone&period=custom&period_start_day=1&period_start_month=1&period_start_year=2000&period_end_day=29&period_end_month=1&period_end_year=2018&editorial_source=&paper_channel=460&page=']
    list_url_articles = []
