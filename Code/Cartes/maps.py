...
# plus meurtriers. Nous avons 6 catastrophes naturelles différentes, ainsi, ce
# code génère 7 cartes, en prenant en compte la cartes pour toutes les
# catastrophe confondues
